...
public static partial class HttpClientExtension
{
    ...
    public static async ValueTask<TResponse?> TrySendToTypeWithRetry<TResponse>(this System.Net.Http.HttpClient client, string uri, int numberOfRetries = 2,
    ...
    /// <param name="log"></param>
    /// <param name="cancellationToken"></param>
    public static async ValueTask<TResponse?> TrySendToTypeWithRetry<TResponse>(this System.Net.Http.HttpClient client, HttpMethod httpMethod, string uri, object? request = null, int numberOfRetries = 2,
        ILogger? logger = null, TimeSpan? baseDelay = null, bool log = true, CancellationToken cancellationToken = default)
    {
    ...
    /// </remarks>
    public static async ValueTask<TResponse?> TrySendToTypeWithRetry<TResponse>(this System.Net.Http.HttpClient client, System.Net.Http.HttpRequestMessage request,
